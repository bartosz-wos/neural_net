...
$(BUILD_DIR)/test_spatial_transformer $(BUILD_DIR)/test_transformer_decoder $(BUILD_DIR)/test_hypernetwork $(BUILD_DIR)/test_instance_norm $(BUILD_DIR)/test_ademamix
